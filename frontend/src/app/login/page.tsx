    ...
    return (
        <div className="flex h-screen bg-[#020617] overflow-hidden">
            ...
            <div className="flex-1 h-full overflow-y-auto scrollbar-none flex flex-col items-center p-8 md:p-16 py-12 md:py-24 z-10 relative pb-40">
                ...
                <div className="w-full max-w-md space-y-12 relative animate-in fade-in slide-in-from-left-4 duration-700">
                    {/* Branding Section */}
                    <div className="flex flex-col items-center gap-4 text-center">
                        <div className="w-16 h-16 rounded-2xl bg-slate-900 border border-slate-700/60 shadow-2xl flex items-center justify-center p-2">
                    ...
                    <div className="glass-card rounded-3xl p-8 md:p-10 border border-slate-700/50 shadow-2xl shadow-black/40 bg-slate-900/40 backdrop-blur-xl">
            ...
            <div className="hidden lg:flex flex-[1.2] h-full bg-slate-900 overflow-hidden relative">
                <img 
                    src="/login-bg.png" 
                    alt="CourseFlow Atmosphere" 
                    className="absolute inset-0 w-full h-full object-cover opacity-60 scale-110 animate-pulse duration-[10s]"
                />
