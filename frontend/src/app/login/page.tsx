                    ...
                    <div className="w-full max-w-md space-y-6 relative animate-in fade-in slide-in-from-left-4 duration-700">
                        ...
                        <div className="bg-slate-900/50 rounded-3xl p-6 md:p-8 border border-white/10 shadow-2xl backdrop-blur-xl">
                            ...
                            <div className="mt-8">
                                <div className="relative">
                                    ...
                                    <div className="relative flex justify-center text-xs">
                                        <span className="bg-[#1e293b] px-4 text-slate-400 font-bold uppercase tracking-widest">Or access with</span>
                                    </div>
                                </div>
                            ...
                            <p className="mt-8 text-center text-xs font-bold text-slate-400 uppercase tracking-widest">
                                ...
                                <Link href="/register" className="text-primary hover:text-primary-dark transition-colors underline underline-offset-4">
                                    register
                                </Link>
                            </p>
                        </div>
